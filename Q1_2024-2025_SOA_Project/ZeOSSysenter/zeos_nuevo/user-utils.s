...
.globl clean_screen; .type clean_screen, @function; .align 0; clean_screen:
 pushl %ebp
 movl %esp, %ebp
 movl $41, %eax
 call syscall_sysenter
...
.globl clean_region; .type clean_region, @function; .align 0; clean_region:
 pushl %ebp
 movl %esp, %ebp
 pushl %ebx;
 pushl %esi;
